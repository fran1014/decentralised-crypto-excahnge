...
describe('Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('My Token', 'Token', '1000000');
  ...
  describe('Making orders', async () => {
    ...
    describe('Success', async () => {
      beforeEach(async () => {
        ...
        transaction = await exchange
          .connect(user1)
          .makeOrder(token2.address, amount, token1.address, tokens(1));
        result = await transaction.wait();
      });
